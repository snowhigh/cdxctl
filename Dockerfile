...
RUN wget https://storage.googleapis.com/kubernetes-release/release/v1.5.6/bin/linux/amd64/kubectl -O /usr/local/sbin/kubectl && chmod +x /usr/local/sbin/kubectl
